...
class Tag(MethodView):
    ...
    @blp.alt_response(404, "Tag not found.")
    ...
    def delete(self, tag_id):
        ...
        abort(400, message="Could not delete a tag. Make sure tag is not associated with any items, then try again.")
...
class TagList(MethodView):
    ...
    def post(self, tag_data, store_id):
        # check whether tag already exists for that store
